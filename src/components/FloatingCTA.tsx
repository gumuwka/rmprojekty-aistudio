...
export default function FloatingCTA() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-40 bg-stone-900 text-white p-4 rounded-full shadow-2xl flex items-center justify-center group"
    ...
    >
      ...
      <span className="absolute top-0 right-0 w-3 h-3 bg-white rounded-full border-2 border-stone-900 animate-ping"></span>
    </motion.button>
  );
}
